...
TEST(test_5, e_OperatorLessThan) {
...
TEST(test_6, f_OperatorFunction) {
    Fleet f;
    Vehicle *v1 =new Car("Fiat",5,2016,"gas",1200);
    Vehicle *v2= new Truck("Ford",3,2017,"gas",1400,1000);
